...
//                    alert(searchform);
                    ...
                    {
                        formfields += '<tr><td>'+ffield.fielddescription+'</td><td><input type="text" class="grd-white" id="'+ ffield.fieldname +'" name="'+ ffield.fieldname +'" value="" placeholder="" /></td></tr>';
                    }
                    $("#formFields").empty();
        ...
        $(".addSearchField").click(function(){
            ...
            if($('#searchField').val() === 'merchant')
            {
                ...
                addedSearchField = '<select id="'+$('#searchField').val()+'" name="'+$('#searchField').val()+'" data-form="select2" style="width:200px" data-placeholder="Select merchant">';
            ...
            {
                addedSearchField = '<select id="'+$('#searchField').val()+'" name="'+$('#searchField').val()+'" data-form="select2" style="width:200px" data-placeholder="Select merchantagreement" >';
            ...
            {
                addedSearchField = ' <a href="javascript:void(0);" class="clickdate"><div class="input-append date" data-form="datepicker" data-date="" data-date-format="yyyy-mm-dd"> <input id="'+$('#searchField').val()+'" name="'+$('#searchField').val()+'" class="grd-white" data-form="" size="16" type="text" value=""> <span class="add-on"><i class="icon-th"></i></span> </div></a>';
            ...
            {
                addedSearchField = '<input type="text" class="grd-white" id="'+ $('#searchField').val() +'" name="'+ $('#searchField').val() +'" value="" placeholder="" />';
            }
