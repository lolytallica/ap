    ...
    <ul class="breadcrumb-nav pull-right">
        ...
        <li class="btn-group">
            ...
            <ul class="dropdown-menu">
                @if($num_tobepaid>0)
                <li><a href="{{ route('status/mainvoice', 2) }}"><span class="color-red">{{$num_tobepaid}} invoices to be paid</span></a></li>
                @endif
                @if(@$num_overdue>0)
                <li class="divider"></li>
                <li><a href="{{ route('status/mainvoice', 6) }}"> {{$num_overdue}} overdue invoices </a></li>
                @endif
            </ul>
        </li>
        @endif
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    @if(($new_inv->invoicestatus($new_inv->id)->status == 'draft' || $new_inv->invoicestatus($new_inv->id)->status == 'approved' || $new_inv->invoicestatus($new_inv->id)->status == 'min_payout_not_met' || $new_inv->invoicestatus($new_inv->id)->status == 'tobepaid') && Sentry::getUser()->hasAccess('manage_ma_invoices'))
