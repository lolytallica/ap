        ...
        <div class="span12">
            <div class="box corner-all">
                <div class="box-header grd-white corner-top">
                    ...
                    <span>Merchant Agreement Invoices: <span class="label {{$statuslabel[$status]}}">@lang('admin/invoices/invoices.'. $status )</span>  </span>
                </div>
                <div class="box-body">
                    @if(@count($invoices))
                    <table id="datatablestools" class="table table-hover responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if( ($invoice->invoicestatus($invoice->id)->status == 'draft' || $invoice->invoicestatus($invoice->id)->status == 'approved') && Sentry::getUser()->hasAccess('manage_mainvoices') && !Sentry::getUser()->merchant_id && !Sentry::getUser()->merchantagreement_id)
