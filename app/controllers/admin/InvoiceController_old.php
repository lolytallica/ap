...
class MainvoiceController extends AdminController {
    ...
    public function getIndex($invoicestatus = null)
    {
        ...
        // $invoices = Mainvoice::orderBy('mainvoice.id', 'DESC')->get();

        $invoices = Mainvoice::with(array('mainvoicestatus', 'mainvoicerows', 'merchantagreements'))->get();

        //  $invoices = New Mainvoice;
        if(!(is_null($invoicestatus)))
        {
            //  $status = Mainvoicestatus::where('invoicestatus_id','=',$invoicestatus)->get();
    ...
    public function getStatusinvoices($statusId)
    {
        ...
        $invoices =  Mainvoice::join('mainvoicestatus','mainvoicestatus.mainvoice_id','=','mainvoice.id')->where('mainvoicestatus.id','=',$statusId)->get();

        return View::make('backend/mainvoice/status')->with('invoices',$invoices)->with('invoicestatus',$invoicestatus->status)->with('allstatuses',$allstatuses);
    }
    ...
    public function getShow($invoiceId)
    {
        ...
        return View::make('backend/mainvoice/show', compact('invoice','specificationrows', 'costrows', 'reportrows', 'holdbackrows', 'customrows', 'heldrows', 'incomerows','merchantagreement','conversionrate', 'payments'));
    ...
    public function getLastbalance($merchantagreement)
    {
        /*  $lastbalance = Mainvoice::join('mainvoicestatus','mainvoice.id','=','mainvoicestatus.mainvoice_id')
              ->where('merchantagreement_id','=',$merchant)
    ...
    public function getEdit($invoiceId = null)
    {
        ...
        return View::make('backend/mainvoice/edit', compact('invoice','specificationrows', 'costrows', 'reportrows', 'holdbackrows', 'customrows', 'heldrows', 'incomerows', 'payments','conversionrate'));
    }
